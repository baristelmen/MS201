/*!
* \file   TFEL/Material/LinearIsotropicBehaviourData.hxx
* \brief  this file implements the LinearIsotropicBehaviourData class.
*         File generated by tfel version 4.1.0
* \author Baris Telmen
 */

#ifndef LIB_TFELMATERIAL_LINEARISOTROPIC_BEHAVIOUR_DATA_HXX
#define LIB_TFELMATERIAL_LINEARISOTROPIC_BEHAVIOUR_DATA_HXX
...
class LinearIsotropicBehaviourData;

//! \brief forward declaration
template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType,bool use_qt>
class LinearIsotropicIntegrationData;

//! \brief forward declaration
template<ModellingHypothesis::Hypothesis hypothesis,typename NumericType>
std::ostream&
 operator <<(std::ostream&,const LinearIsotropicBehaviourData<hypothesis, NumericType,false>&);

template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType>
class LinearIsotropicBehaviourData<hypothesis, NumericType,false>
{
...
friend std::ostream& operator<< <>(std::ostream&,const LinearIsotropicBehaviourData&);

/* integration data is declared friend to access   driving variables at the beginning of the time step */
friend class LinearIsotropicIntegrationData<hypothesis, NumericType, false>;
...
#line 14 "LinearIsotropic.mfront"
stress young;
#line 16 "LinearIsotropic.mfront"
real nu;
#line 18 "LinearIsotropic.mfront"
stress H;
#line 20 "LinearIsotropic.mfront"
stress s0;
...
*/
LinearIsotropicBehaviourData()
{}

/*!
* \brief copy constructor
*/
LinearIsotropicBehaviourData(const LinearIsotropicBehaviourData& src)
: eto(src.eto),
sig(src.sig),
young(src.young),
nu(src.nu),
 ...
 */
LinearIsotropicBehaviourData(const NumericType* const ASTERT_,const NumericType* const ASTERmat,
...
*/
LinearIsotropicBehaviourData&
operator=(const LinearIsotropicBehaviourData& src){
this->eto = src.eto;
this->sig = src.sig;
...
}; // end of LinearIsotropicBehaviourDataclass

template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType>
std::ostream&
operator <<(std::ostream& os,const LinearIsotropicBehaviourData<hypothesis, NumericType, false>& b)
{
os << "εᵗᵒ : " << b.eto << '\n';
os << "σ : " << b.sig << '\n';
os << "young : " << b.young << '\n';
...
#endif /* LIB_TFELMATERIAL_LINEARISOTROPIC_BEHAVIOUR_DATA_HXX */
