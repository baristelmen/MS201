/*!
* \file   include/MFront/Aster/asterNonLinearIsotropicNonLinearKinematic.hxx
* \brief  This file declares the aster interface for the NonLinearIsotropicNonLinearKinematic behaviour law
* \author 
* \date   
*/

#ifndef LIB_ASTER_NONLINEARISOTROPICNONLINEARKINEMATIC_HXX
#define LIB_ASTER_NONLINEARISOTROPICNONLINEARKINEMATIC_HXX
...
struct AsterTraits<tfel::material::NonLinearIsotropicNonLinearKinematic<H, NumericType,false> >
{
//! behaviour type
...
asternonlinearisotropicnonlinearkinematic_setOutOfBoundsPolicy(const int);

MFRONT_SHAREDOBJ int
asternonlinearisotropicnonlinearkinematic_setParameter(const char *const,const double);

MFRONT_SHAREDOBJ int
asternonlinearisotropicnonlinearkinematic_setUnsignedShortParameter(const char *const,const unsigned short);

MFRONT_SHAREDOBJ char *asternonlinearisotropicnonlinearkinematic_getIntegrationErrorMessage();
...
#endif /* LIB_ASTER_NONLINEARISOTROPICNONLINEARKINEMATIC_HXX */
