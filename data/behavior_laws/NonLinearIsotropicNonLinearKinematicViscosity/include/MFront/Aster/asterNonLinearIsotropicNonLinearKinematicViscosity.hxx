/*!
* \file   include/MFront/Aster/asterNonLinearIsotropicNonLinearKinematicViscosity.hxx
* \brief  This file declares the aster interface for the NonLinearIsotropicNonLinearKinematicViscosity behaviour law
* \author Baris Telmen
* \date   
*/

#ifndef LIB_ASTER_NONLINEARISOTROPICNONLINEARKINEMATICVISCOSITY_HXX
#define LIB_ASTER_NONLINEARISOTROPICNONLINEARKINEMATICVISCOSITY_HXX
...
struct AsterTraits<tfel::material::NonLinearIsotropicNonLinearKinematicViscosity<H, NumericType,false> >
{
//! behaviour type
...
asternonlinearisotropicnonlinearkinematicviscosity_setOutOfBoundsPolicy(const int);

MFRONT_SHAREDOBJ int
asternonlinearisotropicnonlinearkinematicviscosity_setParameter(const char *const,const double);

MFRONT_SHAREDOBJ int
asternonlinearisotropicnonlinearkinematicviscosity_setUnsignedShortParameter(const char *const,const unsigned short);

MFRONT_SHAREDOBJ char *asternonlinearisotropicnonlinearkinematicviscosity_getIntegrationErrorMessage();
...
#endif /* LIB_ASTER_NONLINEARISOTROPICNONLINEARKINEMATICVISCOSITY_HXX */
