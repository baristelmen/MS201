/*!
* \file   TFEL/Material/FullChabocheMemoryIntegrationData.hxx
* \brief  this file implements the FullChabocheMemoryIntegrationData class.
*         File generated by tfel version 4.1.0
* \author Baris Telmen
 */

#ifndef LIB_TFELMATERIAL_FULLCHABOCHEMEMORY_INTEGRATION_DATA_HXX
#define LIB_TFELMATERIAL_FULLCHABOCHEMEMORY_INTEGRATION_DATA_HXX
...
std::ostream&
 operator <<(std::ostream&,const FullChabocheMemoryIntegrationData<hypothesis, NumericType, false>&);

template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType>
class FullChabocheMemoryIntegrationData<hypothesis, NumericType, false>
{
...
friend std::ostream& operator<< <>(std::ostream&,const FullChabocheMemoryIntegrationData&);
...
*/
FullChabocheMemoryIntegrationData()
{}

/*!
* \brief Copy constructor
*/
FullChabocheMemoryIntegrationData(const FullChabocheMemoryIntegrationData& src)
: deto(src.deto),
dt(src.dt),
dT(src.dT)
{}
 ...
 */
FullChabocheMemoryIntegrationData(const NumericType* const ASTERdt_,
...
FullChabocheMemoryIntegrationData&
>::type
scale(const FullChabocheMemoryBehaviourData<hypothesis, NumericType, false>&, const Scal time_scaling_factor){
...
*/
FullChabocheMemoryIntegrationData&
updateDrivingVariables(const FullChabocheMemoryBehaviourData<hypothesis, NumericType, false>&){
return *this;
}

}; // end of FullChabocheMemoryIntegrationDataclass

template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType>
std::ostream&
operator <<(std::ostream& os,const FullChabocheMemoryIntegrationData<hypothesis, NumericType, false>& b)
{
os << "Δεᵗᵒ : " << b.deto << '\n';
os << "σ : " << b.sig << '\n';
os << "Δt : " << b.dt << '\n';
...
#endif /* LIB_TFELMATERIAL_FULLCHABOCHEMEMORY_INTEGRATION_DATA_HXX */
