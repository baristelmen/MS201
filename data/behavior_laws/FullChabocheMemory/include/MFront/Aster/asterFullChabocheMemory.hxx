/*!
* \file   include/MFront/Aster/asterFullChabocheMemory.hxx
* \brief  This file declares the aster interface for the FullChabocheMemory behaviour law
* \author Baris Telmen
* \date   
*/

#ifndef LIB_ASTER_FULLCHABOCHEMEMORY_HXX
#define LIB_ASTER_FULLCHABOCHEMEMORY_HXX
...
struct AsterTraits<tfel::material::FullChabocheMemory<H, NumericType,false> >
{
//! behaviour type
...
static constexpr unsigned short material_properties_nb = 17;
...
asterfullchabochememory_setOutOfBoundsPolicy(const int);

MFRONT_SHAREDOBJ int
asterfullchabochememory_setParameter(const char *const,const double);

MFRONT_SHAREDOBJ int
asterfullchabochememory_setUnsignedShortParameter(const char *const,const unsigned short);

MFRONT_SHAREDOBJ char *asterfullchabochememory_getIntegrationErrorMessage();
...
#endif /* LIB_ASTER_FULLCHABOCHEMEMORY_HXX */
