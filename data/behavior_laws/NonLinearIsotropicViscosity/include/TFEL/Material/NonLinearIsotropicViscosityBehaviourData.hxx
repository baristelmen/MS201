/*!
* \file   TFEL/Material/NonLinearIsotropicViscosityBehaviourData.hxx
* \brief  this file implements the NonLinearIsotropicViscosityBehaviourData class.
*         File generated by tfel version 4.1.0
* \author Baris Telmen
 */

#ifndef LIB_TFELMATERIAL_NONLINEARISOTROPICVISCOSITY_BEHAVIOUR_DATA_HXX
#define LIB_TFELMATERIAL_NONLINEARISOTROPICVISCOSITY_BEHAVIOUR_DATA_HXX
...
class NonLinearIsotropicViscosityBehaviourData;

//! \brief forward declaration
template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType,bool use_qt>
class NonLinearIsotropicViscosityIntegrationData;

//! \brief forward declaration
template<ModellingHypothesis::Hypothesis hypothesis,typename NumericType>
std::ostream&
 operator <<(std::ostream&,const NonLinearIsotropicViscosityBehaviourData<hypothesis, NumericType,false>&);

template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType>
class NonLinearIsotropicViscosityBehaviourData<hypothesis, NumericType,false>
{
...
friend std::ostream& operator<< <>(std::ostream&,const NonLinearIsotropicViscosityBehaviourData&);

/* integration data is declared friend to access   driving variables at the beginning of the time step */
friend class NonLinearIsotropicViscosityIntegrationData<hypothesis, NumericType, false>;
...
#line 17 "NonLinearIsotropicViscosity.mfront"
stress young;
#line 19 "NonLinearIsotropicViscosity.mfront"
real nu;
#line 22 "NonLinearIsotropicViscosity.mfront"
stress R_inf;
#line 23 "NonLinearIsotropicViscosity.mfront"
stress R_0;
#line 24 "NonLinearIsotropicViscosity.mfront"
real b;
#line 25 "NonLinearIsotropicViscosity.mfront"
real K;
#line 26 "NonLinearIsotropicViscosity.mfront"
real m;
...
*/
NonLinearIsotropicViscosityBehaviourData()
{}

/*!
* \brief copy constructor
*/
NonLinearIsotropicViscosityBehaviourData(const NonLinearIsotropicViscosityBehaviourData& src)
: eto(src.eto),
sig(src.sig),
young(src.young),
nu(src.nu),
 ...
 */
NonLinearIsotropicViscosityBehaviourData(const NumericType* const ASTERT_,const NumericType* const ASTERmat,
...
*/
NonLinearIsotropicViscosityBehaviourData&
operator=(const NonLinearIsotropicViscosityBehaviourData& src){
this->eto = src.eto;
this->sig = src.sig;
...
}; // end of NonLinearIsotropicViscosityBehaviourDataclass

template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType>
std::ostream&
operator <<(std::ostream& os,const NonLinearIsotropicViscosityBehaviourData<hypothesis, NumericType, false>& b)
{
os << "εᵗᵒ : " << b.eto << '\n';
os << "σ : " << b.sig << '\n';
os << "young : " << b.young << '\n';
...
#endif /* LIB_TFELMATERIAL_NONLINEARISOTROPICVISCOSITY_BEHAVIOUR_DATA_HXX */
