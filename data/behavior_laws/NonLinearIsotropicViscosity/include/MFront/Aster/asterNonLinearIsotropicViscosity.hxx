/*!
* \file   include/MFront/Aster/asterNonLinearIsotropicViscosity.hxx
* \brief  This file declares the aster interface for the NonLinearIsotropicViscosity behaviour law
* \author Baris Telmen
* \date   
*/

#ifndef LIB_ASTER_NONLINEARISOTROPICVISCOSITY_HXX
#define LIB_ASTER_NONLINEARISOTROPICVISCOSITY_HXX
...
struct AsterTraits<tfel::material::NonLinearIsotropicViscosity<H, NumericType,false> >
{
//! behaviour type
...
asternonlinearisotropicviscosity_setOutOfBoundsPolicy(const int);

MFRONT_SHAREDOBJ int
asternonlinearisotropicviscosity_setParameter(const char *const,const double);

MFRONT_SHAREDOBJ int
asternonlinearisotropicviscosity_setUnsignedShortParameter(const char *const,const unsigned short);

MFRONT_SHAREDOBJ char *asternonlinearisotropicviscosity_getIntegrationErrorMessage();
...
#endif /* LIB_ASTER_NONLINEARISOTROPICVISCOSITY_HXX */
