/*!
* \file   include/MFront/Aster/asterLinearKinematic.hxx
* \brief  This file declares the aster interface for the LinearKinematic behaviour law
* \author Baris Telmen
* \date   
*/

#ifndef LIB_ASTER_LINEARKINEMATIC_HXX
#define LIB_ASTER_LINEARKINEMATIC_HXX
...
struct AsterTraits<tfel::material::LinearKinematic<H, NumericType,false> >
{
//! behaviour type
...
asterlinearkinematic_setOutOfBoundsPolicy(const int);

MFRONT_SHAREDOBJ int
asterlinearkinematic_setParameter(const char *const,const double);

MFRONT_SHAREDOBJ char *asterlinearkinematic_getIntegrationErrorMessage();
...
#endif /* LIB_ASTER_LINEARKINEMATIC_HXX */
