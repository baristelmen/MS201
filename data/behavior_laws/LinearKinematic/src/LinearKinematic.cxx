...
LinearKinematicParametersInitializer::get()
{
static LinearKinematicParametersInitializer i;
return i;
}

LinearKinematicParametersInitializer::LinearKinematicParametersInitializer()
{
this->minimal_time_step_scaling_factor = 0.1;
this->maximal_time_step_scaling_factor = 1.7976931348623e+308;
// Reading parameters from a file
LinearKinematicParametersInitializer::readParameters(*this,"LinearKinematic-parameters.txt");
}

void
LinearKinematicParametersInitializer::set(const char* const key,
const double v){
using namespace std;
...
tfel::raise("LinearKinematicParametersInitializer::set: "
" no parameter named '"+std::string(key)+"'");
}
}

double
LinearKinematicParametersInitializer::getDouble(const std::string& n,
const std::string& v)
{
double value;
...
"LinearKinematicParametersInitializer::getDouble: "
"can't convert '"+v+"' to double for parameter '"+ n+"'");
return value;
}

void
LinearKinematicParametersInitializer::readParameters(LinearKinematicParametersInitializer& pi,const char* const fn){
...
tfel::raise_if(mfront_c,"LinearKinematicParametersInitializer::readParameters: "
...
pi.minimal_time_step_scaling_factor = LinearKinematicParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("maximal_time_step_scaling_factor"==tokens[0]){
pi.maximal_time_step_scaling_factor = LinearKinematicParametersInitializer::getDouble(tokens[0],tokens[1]);
} else {
