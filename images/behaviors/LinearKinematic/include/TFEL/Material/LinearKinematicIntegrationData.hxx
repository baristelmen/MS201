/*!
* \file   TFEL/Material/LinearKinematicIntegrationData.hxx
* \brief  this file implements the LinearKinematicIntegrationData class.
*         File generated by tfel version 4.1.0
* \author Baris Telmen
 */

#ifndef LIB_TFELMATERIAL_LINEARKINEMATIC_INTEGRATION_DATA_HXX
#define LIB_TFELMATERIAL_LINEARKINEMATIC_INTEGRATION_DATA_HXX
...
std::ostream&
 operator <<(std::ostream&,const LinearKinematicIntegrationData<hypothesis, NumericType, false>&);

template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType>
class LinearKinematicIntegrationData<hypothesis, NumericType, false>
{
...
friend std::ostream& operator<< <>(std::ostream&,const LinearKinematicIntegrationData&);
...
*/
LinearKinematicIntegrationData()
{}

/*!
* \brief Copy constructor
*/
LinearKinematicIntegrationData(const LinearKinematicIntegrationData& src)
: deto(src.deto),
dt(src.dt),
dT(src.dT)
{}
 ...
 */
LinearKinematicIntegrationData(const NumericType* const ASTERdt_,
...
LinearKinematicIntegrationData&
>::type
scale(const LinearKinematicBehaviourData<hypothesis, NumericType, false>&, const Scal time_scaling_factor){
...
*/
LinearKinematicIntegrationData&
updateDrivingVariables(const LinearKinematicBehaviourData<hypothesis, NumericType, false>&){
return *this;
}

}; // end of LinearKinematicIntegrationDataclass

template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType>
std::ostream&
operator <<(std::ostream& os,const LinearKinematicIntegrationData<hypothesis, NumericType, false>& b)
{
os << "Δεᵗᵒ : " << b.deto << '\n';
os << "σ : " << b.sig << '\n';
os << "Δt : " << b.dt << '\n';
...
#endif /* LIB_TFELMATERIAL_LINEARKINEMATIC_INTEGRATION_DATA_HXX */
