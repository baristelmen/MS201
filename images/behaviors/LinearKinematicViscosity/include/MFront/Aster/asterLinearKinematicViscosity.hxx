/*!
* \file   include/MFront/Aster/asterLinearKinematicViscosity.hxx
* \brief  This file declares the aster interface for the LinearKinematicViscosity behaviour law
* \author Baris Telmen
* \date   
*/

#ifndef LIB_ASTER_LINEARKINEMATICVISCOSITY_HXX
#define LIB_ASTER_LINEARKINEMATICVISCOSITY_HXX
...
struct AsterTraits<tfel::material::LinearKinematicViscosity<H, NumericType,false> >
{
//! behaviour type
...
asterlinearkinematicviscosity_setOutOfBoundsPolicy(const int);

MFRONT_SHAREDOBJ int
asterlinearkinematicviscosity_setParameter(const char *const,const double);

MFRONT_SHAREDOBJ int
asterlinearkinematicviscosity_setUnsignedShortParameter(const char *const,const unsigned short);

MFRONT_SHAREDOBJ char *asterlinearkinematicviscosity_getIntegrationErrorMessage();
...
#endif /* LIB_ASTER_LINEARKINEMATICVISCOSITY_HXX */
