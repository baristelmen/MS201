/*!
* \file   TFEL/Material/NonLinearIsotropicLinearKinematic.hxx
* \brief  this file implements the NonLinearIsotropicLinearKinematic Behaviour.
*         File generated by tfel version 4.1.0
* \author Baris Telmen
 */

#ifndef LIB_TFELMATERIAL_NONLINEARISOTROPICLINEARKINEMATIC_HXX
#define LIB_TFELMATERIAL_NONLINEARISOTROPICLINEARKINEMATIC_HXX
...
struct NonLinearIsotropicLinearKinematicParametersInitializer
{
static NonLinearIsotropicLinearKinematicParametersInitializer&
get();
...
NonLinearIsotropicLinearKinematicParametersInitializer(const NonLinearIsotropicLinearKinematicParametersInitializer&);

NonLinearIsotropicLinearKinematicParametersInitializer&
operator=(const NonLinearIsotropicLinearKinematicParametersInitializer&);
/*!
 * \brief read the parameters from the given file
 * \param[out] pi : parameters initializer
 * \param[in]  fn : file name
 */
static void readParameters(NonLinearIsotropicLinearKinematicParametersInitializer&,const char* const);
};

//! \brief forward declaration
template<ModellingHypothesis::Hypothesis, typename NumericType, bool use_qt>
struct NonLinearIsotropicLinearKinematic;

//! \brief forward declaration
template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType>
std::ostream&
 operator <<(std::ostream&,const NonLinearIsotropicLinearKinematic<hypothesis, NumericType, false>&);

/*!
 * NonLinearIsotropicLinearKinematic profiler
 */
struct NonLinearIsotropicLinearKinematicProfiler
{
//! return the profiler associated with the behaviour
static mfront::BehaviourProfiler& getProfiler();
}; // end of struct NonLinearIsotropicLinearKinematicProfiler

/*!
* \class NonLinearIsotropicLinearKinematic
* \brief This class implements the NonLinearIsotropicLinearKinematic behaviour.
* \tparam hypothesis: modelling hypothesis.
* \tparam NumericType: numerical type.
* \author Baris Telmen
* Implementation of non - linear isotropic 
* hardening with linear kinematic hardening 
* with viscosity addition 
*/
template<ModellingHypothesis::Hypothesis hypothesis,typename NumericType>
struct NonLinearIsotropicLinearKinematic<hypothesis, NumericType, false> final
: public MechanicalBehaviour<MechanicalBehaviourBase::STANDARDSTRAINBASEDBEHAVIOUR,hypothesis, NumericType, false>,
public NonLinearIsotropicLinearKinematicProfiler,
public NonLinearIsotropicLinearKinematicBehaviourData<hypothesis, NumericType, false>,
public NonLinearIsotropicLinearKinematicIntegrationData<hypothesis, NumericType, false>,
public tfel::math::TinyNewtonRaphsonSolver<2*ModellingHypothesisToStensorSize<hypothesis>::value+1, NumericType, NonLinearIsotropicLinearKinematic<hypothesis, NumericType, false>>{
...
friend std::ostream& operator<< <>(std::ostream&,const NonLinearIsotropicLinearKinematic&);

friend struct tfel::math::TinyNonLinearSolverBase<2*ModellingHypothesisToStensorSize<hypothesis>::value+1, NumericType, NonLinearIsotropicLinearKinematic>;
...
typedef NonLinearIsotropicLinearKinematicBehaviourData<hypothesis, NumericType, false> BehaviourData;
typedef NonLinearIsotropicLinearKinematicIntegrationData<hypothesis, NumericType, false> IntegrationData;
...
#line 28 "NonLinearIsotropicLinearKinematic.mfront"
real& dp;
#line 30 "NonLinearIsotropicLinearKinematic.mfront"
tfel::math::View<StrainStensor> da;

#line 33 "NonLinearIsotropicLinearKinematic.mfront"
bool Fel;
struct{
stress lambda;
stress mu;
...
using std::vector;
{
mfront::BehaviourProfiler::Timer mfront_local_timer(NonLinearIsotropicLinearKinematicProfiler::getProfiler(),mfront::BehaviourProfiler::COMPUTETHERMODYNAMICFORCES);
...
} // end of NonLinearIsotropicLinearKinematic::computeThermodynamicForces
...
using std::vector;
{
mfront::BehaviourProfiler::Timer mfront_local_timer(NonLinearIsotropicLinearKinematicProfiler::getProfiler(),mfront::BehaviourProfiler::COMPUTEFINALTHERMODYNAMICFORCES);
this->sig = (this->sebdata.lambda)*trace(this->eel)*Stensor::Id()+2*(this->sebdata.mu)*this->eel;
}

} // end of NonLinearIsotropicLinearKinematic::computeFinalThermodynamicForces
...
NonLinearIsotropicLinearKinematic() =delete ;
//! \brief Copy constructor (disabled)
NonLinearIsotropicLinearKinematic(const NonLinearIsotropicLinearKinematic&) = delete;
//! \brief Assignement operator (disabled)
NonLinearIsotropicLinearKinematic& operator = (const NonLinearIsotropicLinearKinematic&) = delete;
...
* \brief Constructor
*/
NonLinearIsotropicLinearKinematic(const NonLinearIsotropicLinearKinematicBehaviourData<hypothesis, NumericType, false>& src1,
const NonLinearIsotropicLinearKinematicIntegrationData<hypothesis, NumericType, false>& src2)
: NonLinearIsotropicLinearKinematicBehaviourData<hypothesis, NumericType, false>(src1),
NonLinearIsotropicLinearKinematicIntegrationData<hypothesis, NumericType, false>(src2),
...
using namespace tfel::math;
using std::vector;
this->relative_value_for_the_equivalent_stress_lower_bound = NonLinearIsotropicLinearKinematicParametersInitializer::get().relative_value_for_the_equivalent_stress_lower_bound;
this->theta = NonLinearIsotropicLinearKinematicParametersInitializer::get().theta;
this->epsilon = NonLinearIsotropicLinearKinematicParametersInitializer::get().epsilon;
this->minimal_time_step_scaling_factor = NonLinearIsotropicLinearKinematicParametersInitializer::get().minimal_time_step_scaling_factor;
this->maximal_time_step_scaling_factor = NonLinearIsotropicLinearKinematicParametersInitializer::get().maximal_time_step_scaling_factor;
this->numerical_jacobian_epsilon = NonLinearIsotropicLinearKinematicParametersInitializer::get().numerical_jacobian_epsilon;
this->iterMax = NonLinearIsotropicLinearKinematicParametersInitializer::get().iterMax;
}
 ...
 */
NonLinearIsotropicLinearKinematic(const NumericType* const ASTERdt_,
...
: NonLinearIsotropicLinearKinematicBehaviourData<hypothesis, NumericType,false>(ASTERT_,ASTERmat,
ASTERint_vars,ASTERext_vars),
NonLinearIsotropicLinearKinematicIntegrationData<hypothesis, NumericType,false>(ASTERdt_,ASTERdT_,ASTERdext_vars),
deel(tfel::math::map<StrainStensor, 0>(this->zeros)),
dp(this->zeros(StensorSize)),
da(tfel::math::map<StrainStensor, StensorSize+1>(this->zeros)),
dsig_ddeto(Dt)
...
using std::vector;
{
mfront::BehaviourProfiler::Timer mfront_local_timer_binit(NonLinearIsotropicLinearKinematicProfiler::getProfiler(),mfront::BehaviourProfiler::BEFOREINITIALIZELOCALVARIABLES);
...
{
mfront::BehaviourProfiler::Timer mfront_local_timer_init(NonLinearIsotropicLinearKinematicProfiler::getProfiler(),mfront::BehaviourProfiler::INITIALIZELOCALVARIABLES);
#line 36 "NonLinearIsotropicLinearKinematic.mfront"
StressStensor scin = computeElasticPrediction();
#line 37 "NonLinearIsotropicLinearKinematic.mfront"
scin -= 2.*this->C*this->a/3.;
#line 38 "NonLinearIsotropicLinearKinematic.mfront"
const stress seq = sigmaeq(scin);
#line 39 "NonLinearIsotropicLinearKinematic.mfront"
const stress Rpel = this->R_inf + (this->R_0 - this->R_inf)*exp(-this->b*this->p);
#line 40 "NonLinearIsotropicLinearKinematic.mfront"
this->Fel = seq - Rpel > 0;
}
return true;
}
...
{
mfront::BehaviourProfiler::Timer mfront_local_timer(NonLinearIsotropicLinearKinematicProfiler::getProfiler(),mfront::BehaviourProfiler::COMPUTEPREDICTIONOPERATOR);
...
{
mfront::BehaviourProfiler::Timer mfront_local_timer(NonLinearIsotropicLinearKinematicProfiler::getProfiler(),mfront::BehaviourProfiler::INTEGRATOR);
tfel::math::TinyNewtonRaphsonSolver<2*ModellingHypothesisToStensorSize<hypothesis>::value+1, NumericType, NonLinearIsotropicLinearKinematic<hypothesis, NumericType, false>>::epsilon = this->epsilon;
tfel::math::TinyNewtonRaphsonSolver<2*ModellingHypothesisToStensorSize<hypothesis>::value+1, NumericType, NonLinearIsotropicLinearKinematic<hypothesis, NumericType, false>>::iterMax = this->iterMax;
...
} // end of NonLinearIsotropicLinearKinematic::integrate
...
{
mfront::BehaviourProfiler::Timer mfront_local_timer_lu(NonLinearIsotropicLinearKinematicProfiler::getProfiler(),mfront::BehaviourProfiler::TINYMATRIXSOLVE);
mfront_success = tfel::math::TinyNewtonRaphsonSolver<2*ModellingHypothesisToStensorSize<hypothesis>::value+1, NumericType, NonLinearIsotropicLinearKinematic<hypothesis, NumericType, false>>::solveLinearSystem(mfront_matrix, mfront_vector);
}
...
using namespace tfel::math;
using std::vector;
mfront::BehaviourProfiler::Timer mfront_local_timer(NonLinearIsotropicLinearKinematicProfiler::getProfiler(),mfront::BehaviourProfiler::COMPUTEFDF);
...
feel -= this->deto;
#line 44 "NonLinearIsotropicLinearKinematic.mfront"
constexpr const real eps = 1.e-12;
#line 45 "NonLinearIsotropicLinearKinematic.mfront"
if ((this->Fel))
#line 46 "NonLinearIsotropicLinearKinematic.mfront"
{
#line 47 "NonLinearIsotropicLinearKinematic.mfront"
const auto mu       =   computeMu((this->young),(this->nu));
#line 48 "NonLinearIsotropicLinearKinematic.mfront"
StressStensor scin  =   (this->sig);
#line 49 "NonLinearIsotropicLinearKinematic.mfront"
StrainStensor a_    =   (this->a) + theta*(this->da);
#line 50 "NonLinearIsotropicLinearKinematic.mfront"
scin               -=   2.*(this->C)*a_/3.;
#line 51 "NonLinearIsotropicLinearKinematic.mfront"
const stress seq    =   sigmaeq(scin);
#line 53 "NonLinearIsotropicLinearKinematic.mfront"
const real p_       =   (this->p) + theta*(this->dp);
#line 54 "NonLinearIsotropicLinearKinematic.mfront"
const real Rp       =   (this->R_inf) + ((this->R_0) - (this->R_inf))*exp(-(this->b)*p_);
#line 56 "NonLinearIsotropicLinearKinematic.mfront"
const stress F      =   max(seq - Rp, stress(0));
#line 57 "NonLinearIsotropicLinearKinematic.mfront"
const real Fexp     =   pow(F/(this->K),(this->m)-1)/(this->K);
#line 58 "NonLinearIsotropicLinearKinematic.mfront"
const auto iseq     =   1/max(seq,eps*(this->young));
#line 60 "NonLinearIsotropicLinearKinematic.mfront"
const Stensor n     =   3*deviator(scin)*iseq/2.;
#line 62 "NonLinearIsotropicLinearKinematic.mfront"
const Stensor4 Jmn  =   Stensor4::M() - (n^n);
#line 63 "NonLinearIsotropicLinearKinematic.mfront"
const auto vp       =   Fexp*F;
#line 65 "NonLinearIsotropicLinearKinematic.mfront"
feel               +=   (this->dp)*n;
#line 66 "NonLinearIsotropicLinearKinematic.mfront"
fp                 -=   vp * (this->dt);
#line 67 "NonLinearIsotropicLinearKinematic.mfront"
fa                 =   (this->da) - (this->dp)*n;
#line 69 "NonLinearIsotropicLinearKinematic.mfront"
dfeel_ddeel        +=   2*mu*theta*(this->dp)*Jmn*iseq ;
#line 70 "NonLinearIsotropicLinearKinematic.mfront"
dfeel_ddp           =   n;
#line 71 "NonLinearIsotropicLinearKinematic.mfront"
dfeel_dda            =   -2*(this->C)*(this->dp)*theta*iseq*Jmn/3.;
#line 73 "NonLinearIsotropicLinearKinematic.mfront"
dfp_ddp             =   1. + theta* Fexp *(this->m) *(this->dt)*(this->b)*((this->R_inf)-Rp);
#line 74 "NonLinearIsotropicLinearKinematic.mfront"
dfp_ddeel           =  - 2*Fexp*(this->m)*(this->dt)* 2.*mu*theta*(n|Stensor4::M())/3.;
#line 75 "NonLinearIsotropicLinearKinematic.mfront"
dfp_dda             =   2*Fexp*(this->m)*(this->dt)*(this->C)*theta/3.*n;
#line 77 "NonLinearIsotropicLinearKinematic.mfront"
dfa_ddeel           =   -2*mu*theta*(this->dp)*Jmn *iseq;
#line 78 "NonLinearIsotropicLinearKinematic.mfront"
dfa_ddp             =   -n;
#line 79 "NonLinearIsotropicLinearKinematic.mfront"
dfa_dda             =   Stensor4::Id() + 2*(this->C)/3.*(this->dp)*theta*iseq*Jmn;
#line 81 "NonLinearIsotropicLinearKinematic.mfront"
}
...
GetPartialJacobianInvert(NonLinearIsotropicLinearKinematic& mfront_behaviour_argument,
...
private:
NonLinearIsotropicLinearKinematic& mfront_get_partial_jacobian_invert_behaviour;
...
{
mfront::BehaviourProfiler::Timer mfront_local_timer(NonLinearIsotropicLinearKinematicProfiler::getProfiler(),mfront::BehaviourProfiler::COMPUTETANGENTOPERATOR);
if((smt==ELASTIC)||(smt==SECANTOPERATOR)){
computeAlteredElasticStiffness<hypothesis, stress>::exe(Dt,this->sebdata.lambda,this->sebdata.mu);
...
//!
~NonLinearIsotropicLinearKinematic()
 override = default;
...
}; // end of NonLinearIsotropicLinearKinematic class

template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType>
std::ostream&
operator <<(std::ostream& os,const NonLinearIsotropicLinearKinematic<hypothesis, NumericType, false>& b)
{
os << "εᵗᵒ : " << b.eto << '\n';
os << "Δεᵗᵒ : " << b.deto << '\n';
os << "σ : " << b.sig << '\n';
...
/*!
* Partial specialisation for NonLinearIsotropicLinearKinematic.
*/
template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType>
class MechanicalBehaviourTraits<NonLinearIsotropicLinearKinematic<hypothesis, NumericType, false> >
{
...
static constexpr size_type material_properties_nb = 8;
...
return "NonLinearIsotropicLinearKinematic";
}
...
class MechanicalBehaviourTraits<NonLinearIsotropicLinearKinematic<ModellingHypothesis::AXISYMMETRICALGENERALISEDPLANESTRESS, NumericType, false> >
{
using size_type = unsigned short;
public:
...
*/
template<typename NumericType>
class MechanicalBehaviourTraits<NonLinearIsotropicLinearKinematic<ModellingHypothesis::PLANESTRESS, NumericType, false> >
{
using size_type = unsigned short;
public:
static constexpr bool is_defined = false;
...
#endif /* LIB_TFELMATERIAL_NONLINEARISOTROPICLINEARKINEMATIC_HXX */
