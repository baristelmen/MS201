/*!
* \file   include/MFront/Aster/asterLinearIsotropic.hxx
* \brief  This file declares the aster interface for the LinearIsotropic behaviour law
* \author Baris Telmen
* \date   
*/

#ifndef LIB_ASTER_LINEARISOTROPIC_HXX
#define LIB_ASTER_LINEARISOTROPIC_HXX
...
struct AsterTraits<tfel::material::LinearIsotropic<H, NumericType,false> >
{
//! behaviour type
...
asterlinearisotropic_setOutOfBoundsPolicy(const int);

MFRONT_SHAREDOBJ int
asterlinearisotropic_setParameter(const char *const,const double);

MFRONT_SHAREDOBJ char *asterlinearisotropic_getIntegrationErrorMessage();
...
#endif /* LIB_ASTER_LINEARISOTROPIC_HXX */
