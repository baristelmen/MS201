/*!
* \file   TFEL/Material/LinearIsotropicIntegrationData.hxx
* \brief  this file implements the LinearIsotropicIntegrationData class.
*         File generated by tfel version 4.1.0
* \author Baris Telmen
 */

#ifndef LIB_TFELMATERIAL_LINEARISOTROPIC_INTEGRATION_DATA_HXX
#define LIB_TFELMATERIAL_LINEARISOTROPIC_INTEGRATION_DATA_HXX
...
std::ostream&
 operator <<(std::ostream&,const LinearIsotropicIntegrationData<hypothesis, NumericType, false>&);

template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType>
class LinearIsotropicIntegrationData<hypothesis, NumericType, false>
{
...
friend std::ostream& operator<< <>(std::ostream&,const LinearIsotropicIntegrationData&);
...
*/
LinearIsotropicIntegrationData()
{}

/*!
* \brief Copy constructor
*/
LinearIsotropicIntegrationData(const LinearIsotropicIntegrationData& src)
: deto(src.deto),
dt(src.dt),
dT(src.dT)
{}
 ...
 */
LinearIsotropicIntegrationData(const NumericType* const ASTERdt_,
...
LinearIsotropicIntegrationData&
>::type
scale(const LinearIsotropicBehaviourData<hypothesis, NumericType, false>&, const Scal time_scaling_factor){
...
*/
LinearIsotropicIntegrationData&
updateDrivingVariables(const LinearIsotropicBehaviourData<hypothesis, NumericType, false>&){
return *this;
}

}; // end of LinearIsotropicIntegrationDataclass

template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType>
std::ostream&
operator <<(std::ostream& os,const LinearIsotropicIntegrationData<hypothesis, NumericType, false>& b)
{
os << "Δεᵗᵒ : " << b.deto << '\n';
os << "σ : " << b.sig << '\n';
os << "Δt : " << b.dt << '\n';
...
#endif /* LIB_TFELMATERIAL_LINEARISOTROPIC_INTEGRATION_DATA_HXX */
